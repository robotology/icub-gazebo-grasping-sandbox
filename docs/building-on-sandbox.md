...
To include your method, just [open up a PR to change the table](https://github.com/robotology/icub-gazebo-grasping-sandbox/edit/main/docs/building-on-sandbox.md) 👋🏻
...
| SW for Robotics | [@xenvre](https://github.com/xenvre) | Object handover with the iCub robot using the 6D object pose provided by the [ROFT](https://github.com/hsp-iit/ROFT) tracker. | [hsp-iit/roft-samples](https://github.com/hsp-iit/roft-samples/blob/main/src/handover/include/cardinal_points_grasp.h) |
